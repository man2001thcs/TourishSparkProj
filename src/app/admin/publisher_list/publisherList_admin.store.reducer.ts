...
export const reducer = createReducer(
  ...
  on(PublisherListAction.deletePublisher, (state, { payload }) => ({
    ...state,
  })),

  on(PublisherListAction.deletePublisherSuccess, (state, { response }) => ({
    ...state,
    deleteStatus: response,
  })),

  on(PublisherListAction.deletePublisherFailed, (state, { response }) => ({
    ...state,
    messageCode: response.messageCode,
  })),

  on(PublisherListAction.deletePublisherSystemFailed, (state, { error }) => ({
    ...state,
    error: error,
  })),
