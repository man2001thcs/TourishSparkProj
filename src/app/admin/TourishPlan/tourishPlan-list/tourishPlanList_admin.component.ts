...
import { TourishPlan } from "./tourishPlanList_admin.component.model";
import { catchError, map, startWith, switchMap } from "rxjs/operators";
import { Store } from "@ngrx/store";
import { Observable, Subscription } from "rxjs";
import { State as TourishPlanListState } from "./tourishPlanList_admin.store.reducer";
import {
  getTourishPlanList,
  getDeleteStatus,
  getMessage,
  getSysError,
} from "./tourishPlanList_admin.store.selector";
import * as TourishPlanListActions from "./tourishPlanList_admin.store.action";
...
@Component({
  ...
  templateUrl: "./tourishPlanList_admin.component.html",
  styleUrls: ["./tourishPlanList_admin.component.css"],
})
