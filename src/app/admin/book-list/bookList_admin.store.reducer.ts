...
export const reducer = createReducer(
  ...
  on(BookListAction.deleteBook, (state, { payload }) => ({
    ...state,
  })),

  on(BookListAction.deleteBookSuccess, (state, { response }) => ({
    ...state,
    deleteStatus: response,
  })),

  on(BookListAction.deleteBookFailed, (state, { response }) => ({
    ...state,
    messageCode: response.messageCode,
  })),

  on(BookListAction.deleteBookSystemFailed, (state, { error }) => ({
    ...state,
    error: error,
  })),
