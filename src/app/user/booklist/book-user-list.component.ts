...
export class BookUserlistComponent implements OnInit, AfterViewInit {
  book_list!: Book[];
  books_length = 0;
  ...
  ngOnInit(): void {
    ...
    this.userDataService
      ...
      .subscribe((books) => {
        ...
        this.books_length = books.length ?? 10;
  ...
  ngAfterViewInit(): void {
    ...
    this.paraginator.page
      .pipe(
        startWith({}),
        switchMap(() => {
          return this.userDataService.getBookList(this.paraginator.pageIndex + 1, 10);
        }),
        map((data) => {
