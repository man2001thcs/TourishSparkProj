...
import { BookListStoreService } from "./bookList_search.store.service";
import * as BookListAction from "./bookList_search.store.action";
import { BookListUnionActions } from "./bookList_search.store.action";

@Injectable()
export class BookListCategoryEffects {
  constructor(
